...
```bash
python3 ~/.claude/skills/foundry-image-gen/scripts/generate_image.py \
...
```bash
python3 ~/.claude/skills/foundry-image-gen/scripts/generate_tileset.py \
...
```bash
python3 ~/.claude/skills/foundry-image-gen/scripts/generate_animation.py \
...
```bash
python3 ~/.claude/skills/foundry-image-gen/scripts/pixelize.py \
...
```bash
python3 ~/.claude/skills/foundry-image-gen/scripts/qa_report.py \
